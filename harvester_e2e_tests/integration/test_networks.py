...
class TestBackendNetwork:
    ...
    def test_mgmt_vlan_network_connection(self, api_client, request, client, unique_name,
    ...
    def ssh_jumpstart(self, client, dest_ip, client_ip, client_user, client_password,
        ...
        tcp_forward_command = "sudo sed -i 's/AllowTcpForwarding no/AllowTcpForwarding yes/g'" + \
            "/etc/ssh/sshd_config;sudo systemctl restart sshd.service"
        client.exec_command(tcp_forward_command)
